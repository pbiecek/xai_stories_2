...
Additionally, all of our models are interpretable using multiple explainable machine learning techniques such as SHAP @lundberg2017unified, LIME @ribeiro2016should, PDP @friedman2001greedy, Ceteris Paribus Profiles @goldstein2014peeking, and Variable Importance @fisher2019models. For SHAP we used original implementation (https://github.com/slundberg/shap), for other methods, we used XAI package dalex @biecek2018dalex.
