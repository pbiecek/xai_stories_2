...
```{r, out.width="800", fig.align="center", echo=FALSE, fig.cap='Daily total sales, average temperature, precipitation in milimiters'}
knitr::include_graphics('images/sales_temperature_precipitation.png')
```
...
knitr::include_graphics('images/garden_sales.png')
```
...
knitr::include_graphics('images/shap1.png')
```
...
knitr::include_graphics('images/shap2.png')
```
...
```{r, out.width="800", fig.align="center", echo=FALSE, fig.cap='Ceteris Paribut Profiles of a few features'}
knitr::include_graphics('images/cp.png')
```
...
knitr::include_graphics('images/pi.png')
```
...
knitr::include_graphics('images/dd.png')
```
