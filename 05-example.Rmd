...
So we tried improve our clustering by using preprocessing (clearing short words and numbers and lemmatization) on item descriptions. And some clusters are evidently better. This time the most important is "motor" or "motocykl". What again makes perfect sens.

![](./images/05-Lime_motor.jpg "Lime dla klastra z motorami")
But also this time there are some "bad" clusters. Below is example, where most important word is red (in polish and in czech language).
